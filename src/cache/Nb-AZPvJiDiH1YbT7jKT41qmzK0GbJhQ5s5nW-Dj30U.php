...
// PUG_DEBUG:0
 ?><accueil<?= (is_bool($_pug_temp = $pugModule['Phug\\Formatter\\Format\\BasicFormat::attributes_assignment'](['class' => 'pug'], array(  ))) ? var_export($_pug_temp, true) : $_pug_temp) ?>></accueil>
